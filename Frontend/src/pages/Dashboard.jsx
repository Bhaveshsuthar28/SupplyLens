...
export default function Dashboard() {
  ...
  // Performance Trend — fetched from backend (list endpoint omits weekly_scores)
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <ChartCard title="Performance Trend">
              {performanceTrend.length === 0 ? (
                <div className="h-[200px] flex items-center justify-center text-xs text-sidebar-foreground/40 font-mono">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <LineChart data={performanceTrend}>
                    ...
                    <YAxis domain={[50, 100]} tick={chartStyle} stroke="hsl(210,14%,50%)" />
                    <Tooltip contentStyle={{ background: "#ffffff", border: "1px solid #bfdbfe", color: "#1e3a8a", fontFamily: "'IBM Plex Mono'", fontSize: 11, borderRadius: "6px", boxShadow: "0 4px 12px rgba(37,99,235,0.12)" }} />
