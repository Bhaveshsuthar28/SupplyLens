...
function getRecommendations(supplier) {
  const recs = [];
...
function buildEmailSubject(supplier) {
  if (supplier.grade === 'D')
...
function buildEmailBody(supplier) {
...
function EmailModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl w-[calc(100vw-2rem)] sm:w-full p-0 gap-0 flex flex-col max-h-[90vh] overflow-hidden">
        {/* Header stripe */}
        <div className={`px-4 sm:px-6 py-4 flex items-center gap-3 ${isD ? 'bg-destructive' : 'bg-orange-500'}`}>
        ...
        {/* Grade badge strip */}
        <div className={`px-4 sm:px-6 py-2.5 flex flex-wrap items-center gap-2 text-xs font-medium ${isD ? 'bg-red-50 border-b border-red-100' : 'bg-orange-50 border-b border-orange-100'}`}>
        ...
        {/* Footer */}
        <div className="px-4 sm:px-6 py-3 sm:py-4 bg-muted/30 border-t border-border flex flex-wrap items-center justify-between gap-2">
