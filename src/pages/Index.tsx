...
import { BarChart3, TrendingUp, Package, ShieldAlert, ClipboardCheck, Truck, Upload, ArrowRight, CheckCircle2 } from "lucide-react";
...
function UserMenu() {
  ...
  const handleItemClick = (item: { label: string; path: string | null }) => {
    setOpen(false);
  ...
  return (
    <div ref={ref} className="flex items-center justify-end" style={{ gap: 0 }}>
      {/* Items strip — slides out to the left of the avatar pill */}
      <div
        style={{
          maxWidth: open ? "640px" : "0px",
          overflow: "hidden",
          flexShrink: 0,
          transition: open
      ...
      >
        ...
        >
          {allItems.map(({ label, icon, path }, i) => (
            <button
              key={label}
              ...
              style={{
                ...
                cursor: "pointer",
                whiteSpace: "nowrap",
                color: label === "Sign out" ? "#ef4444" : "#111827",
            ...
            >
              <svg
                ...
                fill="none"
                stroke={label === "Sign out" ? "#ef4444" : "#111827"}
                strokeWidth="1.7"
                viewBox="0 0 24 24"
              >
          ...
          <div
            style={{
              ...
              opacity: open ? 0.7 : 0,
              transition: open
                ? `opacity 180ms ${60 + allItems.length * 70}ms ease`
                : "opacity 60ms ease",
            }}
          />
        </div>
      ...
      <div
        style={{
          ...
          transition:
            "border-radius 420ms cubic-bezier(0.22,1,0.36,1), border-color 300ms ease, box-shadow 300ms ease",
        }}
      >
        {/* Avatar button */}
        <button
          ...
          style={{
            ...
            transition:
              "box-shadow 260ms ease, transform 320ms cubic-bezier(0.34,1.56,0.64,1)",
          }}
        >
          {/* Person icon — closed */}
          <svg
      ...
      <section>
        <div className="container py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((f) => (
              <div key={f.title} className="bg-white/70 rounded-xl p-8 shadow-sm">
